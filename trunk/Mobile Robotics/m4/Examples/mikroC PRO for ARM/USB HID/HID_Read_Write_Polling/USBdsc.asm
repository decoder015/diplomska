_USB_Init_Desc:
;USBdsc.c,160 :: 		void USB_Init_Desc(){
;USBdsc.c,161 :: 		USB_config_dsc_ptr[0] = &configDescriptor1;
...
STR	R1, [R0, #0]
;USBdsc.c,162 :: 		USB_string_dsc_ptr[0] = (const char*)&strd1;
...
STR	R1, [R0, #0]
;USBdsc.c,163 :: 		USB_string_dsc_ptr[1] = (const char*)&strd2;
...
STR	R1, [R0, #0]
;USBdsc.c,164 :: 		USB_string_dsc_ptr[2] = (const char*)&strd3;
